...
- Player Name Prefix System Overhaul
  - Added [a page](https://1a3.uk/games/repo/mods/lobbyimprovements) on my website that lets you automatically sync your [in-game roles](https://github.com/1A3Dev/REPO-LobbyImprovements/blob/master/README.md#-player-roles) with the roles you have in the R.E.P.O. and R.E.P.O. Modding Discord servers. If you'd rather not authenticate on my site, just DM me on Discord and I'll assign whichever roles you're eligible for.
